...
export default function HealthMapperPage() {
  ...
  const handleGenerateMappingSpec = async () => {
    ...
    setMappingSpec(''); // Clear previous spec
    setGeneratedCode(''); // Clear previous code
    setFhirOutput(''); // Clear previous output
    try {
  ...
  const handleExecuteCode = () => {
    ...
    // Use a timeout to ensure UI updates before potentially long-running/blocking script
    setTimeout(() => {
      try {
        // This is a simplified execution model.
        // Assumes the generated code defines a function like `transformHL7MessageToFHIR` or `transform`.
        // The AI flow for code generation might need to be prompted to produce code in this format.
        const scriptToExecute = `
          ...
          if (typeof transformHL7MessageToFHIR === 'function') {
            ...
            // If the AI generates code that immediately executes and produces a result,
            // this Function constructor might not capture it unless it's the last expression.
            // For more complex scenarios, a more robust sandboxed execution environment would be needed.
  ...
  return (
    <div className="container mx-auto p-4 md:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-6">
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Paste your HL7 message below to start the transformation process.</CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
        ...
        {/* Column 2: Code and Output */}
        <div className="flex flex-col gap-6">
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6 text-primary"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
                Generated JavaScript Code
              </CardTitle>
              <CardDescription>JavaScript code to perform the HL7 to FHIR transformation.</CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
              ...
              <Button 
                ...
                className="mt-4 w-full"
                variant="default" // Keep this as primary button for execution
              >
                {isExecutingCode ? (
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                ) : (
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Resulting FHIR resource after code execution.</CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
